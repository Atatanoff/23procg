...
@logger.catch
def savemacro(name, ser_write, entry, button, buttonPs):
    ...
    buttonPs.configure(state='disabled')
...
@logger.catch
def Photoshop(ser_write, entry, button, buttonPs):
    # окно
    ...
    bt_macro = customtkinter.CTkButton(new_win_1, text="hold+Tab+qwe", corner_radius=8, width=70,
                                 ...
                                 command=lambda: savemacro("+hold+Tab+qwe", # записываемый макрос
                                                           ser_write, entry,
                                                            button, buttonPs))
    bt_macro.pack()
    ...
    bt_macro = customtkinter.CTkButton(new_win_1, text="F11+Tab+54", corner_radius=8, width=70,
                                 height=70, fg_color="#FFFFFF", text_color="#1C1D21",
                                 hover_color="#B5F22F", font=("", 10),
                                 command=lambda: savemacro("+F11+Tab+54",
                                                           ser_write, entry,
                                                             button, buttonPs))
    bt_macro.pack()
...
@logger.catch
def Enq_page(button, main, key_page):
    value.d_name = dict()
    ...
    key22 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key22", key22, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key22.place(x=151, y=156)

    key23 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key23", key23, button), corner_radius=8, width=106, height=40,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key23.place(x=41, y=147)

    key24 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key24", key24, button), corner_radius=8, width=106, height=40,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key24.place(x=41, y=190)

    key25 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key25", key25, button), corner_radius=8, width=106, height=40,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key25.place(x=225, y=147)

    key26 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key26", key26, button), corner_radius=8, width=106, height=40,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key26.place(x=225, y=190)

    key27 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key27", key27, button), corner_radius=8, width=144, height=50,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
    key27.place(x=411, y=137)

    key28 = customtkinter.CTkButton(Enq_frame, text="Пусто", command=lambda: value.button_function("key28", key28, button), corner_radius=8, width=144, height=50,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
...
def run():
    ...
    def key_page():
        ...
        Enq_key = customtkinter.CTkButton(key_frame, command=lambda:Enq_page(button, main, key_page), text=" ", corner_radius=105, width=70, height=70,
                                        fg_color="#EFEFEF", hover_color=key_hover)
        #print(Enq_key.winfo_name())
        Enq_key.place(x=42, y=38)

        Enq_key2 = customtkinter.CTkButton(key_frame, command=lambda:Enq_page(button, main, key_page), text=" ", corner_radius=5, width=160, height=40,
                                        fg_color="#EFEFEF", hover_color=key_hover)
        #print(Enq_key2.winfo_name())
        Enq_key2.place(x=145, y=55)

        # клавишы
        key1 = customtkinter.CTkButton(key_frame, command=lambda: value.button_function("$key18", key1, button), text="Пусто", corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key1.place(x=337, y=43)

        ToolTip(key1, msg="Ctrl+Alt+e | Ctrl+Alt+shift+e", delay=0, fg="#B5F22F", bg="#1C1D21")

        key2 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key19", key2, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key2.place(x=411, y=43)

        key3 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key20", key3, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key3.place(x=485, y=43)

        key4 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key1", key4, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key4.place(x=41, y=116)

        key5 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key5", key5, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key5.place(x=115, y=116)

        key6 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key6", key6, button),  corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key6.place(x=189, y=116)

        key7 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key9", key7, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key7.place(x=263, y=116)

        key8 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key10", key8, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key8.place(x=337, y=116)

        key9 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key14", key9, button), corner_radius=8, width=70, height=70,
                                    fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key9.place(x=411, y=116)

        key10 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key21", key10, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key10.place(x=485, y=116)

        key11 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key2", key11, button), corner_radius=8, width=144, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key11.place(x=41, y=189)

        key12 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key7", key12, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key12.place(x=189, y=189)

        key13 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key11", key13, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key13.place(x=263, y=189)

        key14 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key12", key14, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key14.place(x=337, y=189)

        key15 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key15", key15, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key15.place(x=411, y=189)

        key16 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key17", key16, button), corner_radius=8, width=70, height=144,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key16.place(x=485, y=189)

        key17 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key3", key17, button, value), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key17.place(x=41, y=262)

        key18 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key4", key18, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key18.place(x=115, y=262)

        key19 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key8", key19, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key19.place(x=189, y=262)

        key20 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key13", key20, button), corner_radius=8, width=144, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        key20.place(x=263, y=262)

        key21 = customtkinter.CTkButton(key_frame, text="Пусто", command=lambda: value.button_function("$key16", key21, button), corner_radius=8, width=70, height=70,
                                        fg_color=key_color, text_color=key_text_color, hover_color=key_hover, font=key_font)
        ...
        buttonPs = customtkinter.CTkButton(toolbar, command=lambda: Photoshop(ser_write, entry, button, buttonPs), text="Photoshop", corner_radius=12, width=90,
        ...
        checkbox = customtkinter.CTkCheckBox(entry_frame, variable=varchboxd, offvalue='', text_color="#881798", text="Двойное",
                                         fg_color="#881798", hover_color="#881798", checkmark_color="#313335",
                                         bg_color="#1C1D21", width=70, checkbox_width=13, checkbox_height=13,
                                         border_width=1, corner_radius=3, command=lambda: value.chboxduble("hold"), onvalue="double")
        checkbox.place(x=340, y=78)
        value.chboxs["double"] = checkbox

        varchboxh = StringVar()
        checkbox = customtkinter.CTkCheckBox(entry_frame, variable=varchboxh, offvalue='', text_color="#881798", text="Удержание",
                                         fg_color="#881798", hover_color="#881798", checkmark_color="#313335",
                                         bg_color="#1C1D21", width=70, checkbox_width=13, checkbox_height=13,
                                         border_width=1, corner_radius=3, command=lambda: value.chboxduble("double"), onvalue="hold")
        checkbox.place(x=440, y=78)
        value.chboxs["hold"] = checkbox
        ...
        def save():
            ...
            savemacro(name, ser_write, entry, button, buttonPs)
